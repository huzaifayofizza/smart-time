...
?>
                           ...
                           <div class="col-md-7 col-lg-6 ">
                              <div class="detail-box">
                                 <h1>
                                   ...
                                   <p>
                                    Watches, more than mere instruments for measuring time, are timeless expressions of craftsmanship and personal style. A well-chosen timepiece is a reflection of one's taste and character, a subtle yet powerful statement worn on the wrist. From the intricate gears beneath the dial to the aesthetic details on the case, each watch is a marvel of engineering and design.
                                 </p>
                                 <div class="">
                                <a class="text-light"style="border: none;" href="product.php">Shop Now</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-7 col-lg-6 ">
                              <div class="detail-box">
                                 ...
                                 <p>
                                 It is a companion through life's moments,  capturing memories. In this world of ever-evolving technology, watches remain steadfast, bridging the past with the present. Whether it's the classic charm of analog watches, the innovation of smartwatches, or the avant-garde designs pushing boundaries, watches are not just about telling time; they're about telling your story with every passing second.
                                 </p>
                                 <div class="">
                                 <a class="text-light"style="border: none;" href="product.php">Shop Now</a>
                                 </div>
      ...
      <section class="why_section layout_padding">
         <div class="container">
            <div class="heading_container heading_center" style="color:#009CFF">
               <h2>
                  Why Shop With Us
               </h2>
            </div>
               ...
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Swift as thought, swift as a promise kept – delivering dreams at your doorstep.
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Sail into savings with the breeze of free shipping – where every order sets sail without a cost.
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Crafted with excellence, our quality speaks louder than words.
                        </p>
                     </div>
                  </div>
               </div>
      ...
      if(ISSET($_POST['submit']))
      {
         ...
         $querryy = "SELECT * FROM `products` WHERE `product_id` = '$prodid' ";
                  ...
                  <div class="col-md-6 offset-md-3">
                     <div class="subscribe_form ">
                        ...
                        <form action="">
                           ...
                           <button class="bg-dark text-light" style="border: none; font-weight:bold">
                           subscribe
                           </button>
                        </form>
                     </div>
